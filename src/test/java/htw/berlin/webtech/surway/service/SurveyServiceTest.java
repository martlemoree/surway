...
class SurveyServiceTest implements WithAssertions {
    ...
    @Test
    @DisplayName("should return false if survey to be deleted doesnt exist")
    void should_return_false_if_survey_to_be_deleted_doesnt_exist() {
        // given
        Long givenId = 111L;
